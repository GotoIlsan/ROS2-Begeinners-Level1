...
bool my_robot_interfaces__msg__list_alive_turtle__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("my_robot_interfaces.msg._list_alive_turtle.ListAliveTurtle", full_classname_dest, 58) == 0);
  }
  my_robot_interfaces__msg__ListAliveTurtle * ros_message = _ros_message;
  {  // names
...
{
  /* NOTE(esteve): Call constructor of ListAliveTurtle */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("my_robot_interfaces.msg._list_alive_turtle");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ListAliveTurtle");
